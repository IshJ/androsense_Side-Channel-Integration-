...
import static com.tritop.androsense2.MainActivity.groundTruthValues;
...
//        Log.d("sidescandb", "groundTruthValues "+groundTruthValues.size());
        ...
        insert_locker.unlock();
        boolean ifcompress = com.tritop.androsense2.Utils.checkfile(context);//get the size of db
        if(ifcompress) {//if the db is larger than limit size, compress it.
            com.tritop.androsense2.Utils.compress(context);
        }
