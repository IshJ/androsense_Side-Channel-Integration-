...
Java_com_tritop_androsense2_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_tritop_androsense2_MainActivity_setSharedMap(JNIEnv *env, jobject thiz) {
    int pp = 0;
    int pp1 = 0;
...
extern "C"
JNIEXPORT int JNICALL
Java_com_tritop_androsense2_MainActivity_createAshMem(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_tritop_androsense2_MainActivity_readAshMem(
        JNIEnv *env,
...
extern "C" JNIEXPORT long JNICALL
Java_com_tritop_androsense2_aspects_AspectLoggingJava_readAshMem1(
        JNIEnv *env,
        jobject thiz, jint fd) {
...
Java_com_tritop_androsense2_MainActivity_setAshMemVal(
        JNIEnv *env,
...
extern "C" JNIEXPORT void JNICALL
Java_com_tritop_androsense2_SideChannelJob_scan(
        JNIEnv *env,
...
extern "C" JNIEXPORT long JNICALL
Java_com_tritop_androsense2_SideChannelJob_scan7(
        JNIEnv *env,
...
extern "C" JNIEXPORT long JNICALL
Java_com_tritop_androsense2_SideChannelJob_readAshMem(
        JNIEnv *env,
        jobject thiz, jint fd) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_tritop_androsense2_SideChannelJob_setAshMemVal(
        JNIEnv *env,
        jobject thiz, jint fd, jlong val) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_tritop_androsense2_SideChannelJob_scanOdex(
        JNIEnv *env,
...
extern "C" JNIEXPORT void JNICALL
Java_com_tritop_androsense2_SideChannelJob_adjustThreshold(JNIEnv *env, jobject thiz,
...
extern "C" JNIEXPORT void JNICALL
Java_com_tritop_androsense2_TrialModelStages_trial1(
...
extern "C" JNIEXPORT void JNICALL
Java_com_tritop_androsense2_SideChannelJob_trial2(
        JNIEnv *env, jobject thiz) {
    LOGD("Start trial 2.\n");
    continueRun = 1;
    hit(&g_lock, compiler_position, &continueRun,
 ...
 */
extern "C" JNIEXPORT jstring JNICALL
Java_com_tritop_androsense2_CacheScan_init(
        JNIEnv *env,
        jobject thiz,
...
Java_com_tritop_androsense2_SideChannelJob_pause(JNIEnv *env, jobject thiz) {
    // to stop scanning;
    continueRun = 0;
}
...
extern "C"
JNIEXPORT int JNICALL
Java_com_tritop_androsense2_activities_RainViewerActivity_nativeChildBMethodB(JNIEnv *env,
                                                                              jobject thiz) {
    int ans = rand() % 50;
...
extern "C" JNIEXPORT void JNICALL
Java_com_tritop_androsense2_SideChannelJob_setSharedMapChild(JNIEnv *env, jobject thiz,
                                                             jint shared_mem_ptr,
                                                             jcharArray fileDes) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_tritop_androsense2_MainActivity_setSharedMapChildTest(JNIEnv *env,
                                                                            jobject thiz,
                                                                            jint shared_mem_ptr,
                                                                            jcharArray fileDes) {
...
Java_com_tritop_androsense2_SideChannelJob_getOdexBegin(JNIEnv *env, jobject thiz,
                                                        jstring fileName) {
